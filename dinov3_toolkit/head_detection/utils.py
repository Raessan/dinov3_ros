...
DETECTION_CLASS_NAMES = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 
...
def img_with_detections(image_np, boxes_xyxy, scores, labels, class_names=None):
    """
